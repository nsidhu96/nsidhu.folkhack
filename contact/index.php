            ...
            <div id="wrap_sub">
                ...
                <section id="main_content">
                    ...
                    <div class ="gutter">
                        ...
                        <div>
                            <ul class="category">
                                <li><div id="info">Phone:</div> 319-892-0504</li>
                                <li class="email"><div id="info">Email:</div> <a href="mailto:nsidhu96@gmail.com">username@restaurant.com</a></li>
                                <li><div id="info">Address:</div> 1234 Restuarant Avenue, Atlanta, GA 30340</li>
                            </ul>
                        </div>
                    </div>
                </section>
